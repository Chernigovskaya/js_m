// Алексей Кадочников Создать механизм для безопасного добавления метаданных к объектам книг с использованием Symbol.
...
addMetadata(book, reviewSymbol, "книга о дистопии!");
